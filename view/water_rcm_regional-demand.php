...
var fileName = "gen2/rcm/water/regional-demand_" + countryLower + "_annual.csv";
...
d3.csv(fileName, function(error, data) {
  data.forEach(function(d) {
    d.date = parseDate(d.year.substring(0,4));
    d.value = +d[seriesName] / ufactor;
  });
