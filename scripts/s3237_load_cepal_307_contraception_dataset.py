...
# Load script for CEPALStat indicator \#307: contraception usage.

# <markdowncell>

# This script imports csv formatted data (generation 2) into the database (generation 3.)
# 
# This script will import data from all files listed in "data/facts/gen2/cepalstat/contraception/_contraception.csv".
...
with smu.get_db_connection() as cursor:
    query = """
            ...
            WHERE O.series like 'contraception\_%\_cepalstat'
            ORDER BY D.year
            """
